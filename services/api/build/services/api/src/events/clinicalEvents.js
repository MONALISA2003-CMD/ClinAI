 ...
 */
export async function enqueueClinicalEvent(client, input) {
    ...
    const result = await client.query(`INSERT INTO outbox_events
      (organization_id,event_type,aggregate_type,aggregate_id,payload,event_key)
     VALUES($1,$2,$3,$4,$5,$6)
     ON CONFLICT (event_key) DO NOTHING
     RETURNING id`, [input.organizationId, input.eventType, input.aggregateType ?? null,

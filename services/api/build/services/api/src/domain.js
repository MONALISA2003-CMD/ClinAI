...
export const ORDER_STATUSES = ['draft', 'ordered', 'accepted', 'in-progress', 'completed', 'verified', 'cancelled', 'rejected'];
export const QUEUE_STATUSES = ['waiting', 'called', 'in-service', 'completed', 'cancelled', 'no-show'];
export const ENCOUNTER_STATUSES = ['planned', 'in-progress', 'completed', 'cancelled'];

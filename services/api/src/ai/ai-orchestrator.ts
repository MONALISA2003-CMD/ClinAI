...
const AI_FALLBACK_ATTEMPTS = Math.max(1, Math.min(5, Number(process.env.CLINAI_AI_FALLBACK_ATTEMPTS || 2)));
...
const AI_PROVIDER_TIMEOUT_MS = Math.max(2500, Number(process.env.CLINAI_PROVIDER_TIMEOUT_MS || 6000));

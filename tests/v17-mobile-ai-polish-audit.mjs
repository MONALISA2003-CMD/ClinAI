...
assert.ok(intelligence.includes('FORMATTING:') && intelligence.includes('Prefer bold section headings') && intelligence.includes('Never output JSON'),'AI human formatting instruction missing');
